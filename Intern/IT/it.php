...
<head>
    ...
    <link href="../../assets/intern-css/IT-css/dashboard.css" rel="stylesheet">
    <link href="../../assets/intern-css/IT-css/requirements.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar-->
        <?php include('components/it-sidebar.php'); ?>

        <!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column">

            <!-- Header Content -->
            <?php include('components/it-header.php'); ?>
