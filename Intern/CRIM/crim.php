...
<head>
    ...
    <link href="../../assets/intern-css/CRIM-css/dashboard.css" rel="stylesheet">
    <link href="../../assets/intern-css/CRIM-css/requirements.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar-->
        <?php include('components/crim-sidebar.php'); ?>

        <!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column">

            <!-- Header Content -->
            <?php include('components/crim-header.php'); ?>
