    ...
    $.ajax({
        ...
        success: function (companies) {
            ...
            if (companies.length === 0) {
                // If no companies are retrieved, set a default background
                document.querySelector('.comp-section').style.backgroundImage = 'url(/AIMS/assets/uploads/comp-img/asiatech.png)';
            }
            ...
            companies.forEach(company => {
                ...
                img.src = company.logo || '/AIMS/assets/images/default-logo.png'; // Fallback to default logo if missing
