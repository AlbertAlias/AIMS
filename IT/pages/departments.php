        ...
        <div class="col-12 col-md-6 col-lg-8">
            <div class="bg-light rounded-3 px-4 py-4 d-flex flex-column" style="min-height: 150px; box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;">
                ...
                <form id="addDepartmentForm">
                    ...
                    <button type="submit" id="deptSubmitBtn" class="btn btn-success me-2">
                    ...
                    <button type="button" id="seeDepartmentsBtn" class="btn btn-info ms-2" data-bs-toggle="modal" data-bs-target="#seeDepartmentsModal">
                        See Departments
                    </button>
