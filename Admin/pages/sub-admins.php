                ...
                <form id="adminsForm">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-5">
                            ...
                            <label for="admin_last_name" class="form-label required-asterisk">Last Name</label>
                            <input type="text" class="form-control" id="admin_last_name" name="admin_last_name" required disabled>
                        </div>

                        <!-- First Name -->
                        <div class="col-md-7">
                            <label for="admin_first_name" class="form-label required-asterisk">First Name</label>
                    ...
                    <div class="row mb-3">
                        ...
                        <!-- Gender -->
                        <div class="col-md-4">
                            <label for="admin_gender" class="form-label required-asterisk">Gender</label>
                    ...
                    <div class="row mb-3">
                        <!-- Address -->
                        <div class="col-md-12">
                            <label for="admin_address" class="form-label required-asterisk">Address</label>
                    ...
                    <div class="row mb-3">
                        <!-- Birthdate -->
                        <div class="col-md-4">
                            <label for="admin_birthdate" class="form-label required-asterisk">Birthdate</label>
                            <input type="date" class="form-control" id="admin_birthdate" name="admin_birthdate" required disabled>
                        </div>
                        <!-- Civil Status -->
                        <div class="col-md-4">
                            <label for="admin_civil_status" class="form-label required-asterisk">Civil Status</label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" class="form-control" id="admin_contact_number" name="admin_contact_number" placeholder="" pattern="[1-9]{10}" maxlength="10" title="Please enter a valid 10-digit phone number" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-end">
                            <button type="button" id="adminCancelBtn" class="btn btn-secondary" style="display: none;">Cancel</button>
                            <button type="button" id="adminUpdateBtn" class="btn btn-primary" style="display: none;">Update</button>
                            <button type="submit" id="adminSubmitBtn" class="btn btn-success" disabled>Submit</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="bg-light rounded-3 shadow px-4 py-4 d-flex flex-column" style="min-height: 200px;">
                ...
                <div class="text-gray-800">
                    <form id="admin_accountForm">
                        <div class="mb-3">
                            <label for="admin_account_email" class="form-label required-asterisk">Account Email</label>
                            <input type="email" class="form-control" id="admin_account_email" name="admin_account_email" required disabled>
                        </div>
                        <div class="mb-3">
                            <label for="admin_password" class="form-label required-asterisk">Password</label>
                            <input type="password" class="form-control" id="admin_password" name="admin_password" required disabled>
                        </div>
                        <div class="mb-3">
                            <label for="role" class="form-label required-asterisk">Role</label>
