...
<head>
    ...
    <link href="../../assets/intern-css/CS-css/dashboard.css" rel="stylesheet">
    <link href="../../assets/intern-css/CS-css/requirements.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar-->
        <?php include('components/cs-sidebar.php'); ?>

        <!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column">

            <!-- Header Content -->
            <?php include('components/cs-header.php'); ?>
