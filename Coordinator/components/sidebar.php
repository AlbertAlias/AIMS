<div class="sidebar-container d-none d-md-flex flex-column p-0 m-0">
    ...
    <nav>
        ...
        <a href="#" class="sidebar-link" onclick="showSection(event, 'stud-requirements')">
...
<script>
    function showSection(event, sectionID) {
        ...
        // Hide all sections
        document.querySelectorAll('#dashboard, #profile, #student, #stud-requirements, #weeklyreport, #stud').forEach(section => {
