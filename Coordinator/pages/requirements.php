        ...
        <div class="col-12 col-md-4 col-lg-4 mb-2">
            <div class="post-container">
                <div class="post-header">
                    ...
                    <input type="text" class="form-control title" id="requirementTitle"
                        placeholder="What's on your mind, Coordinator?">
                </div>
                <div class="post-body mb-2">
                    <textarea rows="3" class="form-control" id="requirementDescription"
                        placeholder="Descriptions"></textarea>
                </div>
                <div class="post-footer d-flex justify-content-between align-items-center">
                    <div class="deadline-container">
                        <input type="text" class="form-control deadline-input" id="deadline"
                            placeholder="Set a deadline" onfocus="(this.type='date')" onblur="(this.type='text')">
                    </div>
                    <div>
                        <button class="btn btn-md btn-success" id="postRequirementBtn">Post</button>
                        <button class="btn btn-md btn-primary" id="updatePostRequirementBtn"
            ...
            <div class="row mt-2">
                <div class="col-lg-12">
                    <a class="requirements-container" id="pendingContainer" data-bs-toggle="modal"
                ...
                <div class="col-lg-12 mt-2 mb-2">
                    <a class="requirements-container" id="rejectedContainer" data-bs-toggle="modal"
                ...
                <div class="col-lg-12 mb-2">
                    <a class="requirements-container" id="completedContainer" data-bs-toggle="modal"
                ...
                <div class="col-lg-12">
                    <a class="requirements-container" id="weeklyreportContainer" data-bs-toggle="modal"
        ...
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between align-items-center w-100">
                ...
                <div class="input-group flex-shrink-1" style="max-width: 350px;">
                    ...
                    <input type="text" id="pendingSearchInput" class="form-control form-control-sm"
        ...
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between align-items-center w-100">
                ...
                <div class="input-group flex-shrink-1" style="max-width: 350px;">
                    ...
                    <input type="text" id="rejectedSearchInput" class="form-control form-control-sm"
                        placeholder="Search..." aria-label="Search">
                    <button class="btn btn-success btn-sm" type="button">
                        <svg class="table-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path fill="#f3f3f3"
        ...
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between align-items-center w-100">
                ...
                <div class="input-group flex-shrink-1" style="max-width: 350px;">
                    ...
                    <input type="text" id="completedSearchInput" class="form-control form-control-sm"
                        placeholder="Search..." aria-label="Search">
                    <button class="btn btn-success btn-sm" type="button">
                        <svg class="table-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path fill="#f3f3f3"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between align-items-center w-100">
                ...
                <div class="input-group flex-shrink-1" style="max-width: 350px;">
                    <input type="text" id="weeklyreportSearchInput" class="form-control form-control-sm"
                        placeholder="Search..." aria-label="Search">
                    <button class="btn btn-success btn-sm" type="button">
                        <svg class="table-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path fill="#f3f3f3"
...
<div class="modal fade" id="remarksModal" tabindex="-1" aria-labelledby="remarksModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <textarea id="remarksTextarea" class="form-control" rows="5"
