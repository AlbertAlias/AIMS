<div class="container-fluid bg-light p-0 m-0" id="stud-requirements" style="display: none;">
    <!-- <div class="row">
        <div class="col-lg-4">
            <h5 class="border-bottom border-secondary pb-2 mb-2">Student Requirements</h5>
        </div>
        <div class="col-lg-4">
            <h5 class="border-bottom border-secondary pb-2 mb-2">Approved Requirements</h5>
        </div>
        <div class="col-lg-4">
            <h5 class="border-bottom border-secondary pb-2 mb-2">Rejected Requirements</h5>
        </div>
    </div> -->
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body bg-white p-0">
            ...
            <div class="table-responsive">
                <table id="student-req" class="table table-hover text-center m-0" style="width: 100%;">
