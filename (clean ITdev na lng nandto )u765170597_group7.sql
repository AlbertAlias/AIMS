...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2025 at 08:27 AM
...
(1499, 'Oliva', 'Catherine', '', 'Catherinemaganda', '$2y$10$1/X0mF3r533RLAeuYG3pRuzk.4DhfKdjuTTCVj7uG/j2wotgnGARC', 'IT', NULL, 'Santa Rosa, Laguna', 'CatherineOliva@gmail.com', 'Female', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `coordinator`
  MODIFY `coordinator_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `requirements`
  MODIFY `requirement_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
...
--
ALTER TABLE `submit_requirements`
  MODIFY `submit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=135;
...
--
ALTER TABLE `users`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1502;
