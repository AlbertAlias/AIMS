...
//                 document.getElementById('chosenRequirement').textContent = ''; // Clear the Chosen Requirement text
    ...
    submitButton.addEventListener('click', function () {
        ...
        .then(data => {
            if (data.success) {
                ...
                fileInput.value = '';
                submitButton.disabled = true;
                document.getElementById('chosenRequirement').textContent = '';
                taskCardContainer.style.display = 'block';
