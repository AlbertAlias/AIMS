                                ...
                                content += `
                                    <div class="card mb-2">
                                        <div class="card-body d-flex align-items-start py-2 px-2">
                                            ...
                                            <!-- Report Title and Week info to the right -->
                                            <div>
                                        ...
                                        <!-- Hidden View Report Button -->
                                        <a href="${report.file_path}" class="btn btn-primary" target="_blank" style="display: none;">View Report</a>
                                    </div>
                                `;
                            });
                        } else {
