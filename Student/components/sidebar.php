<div class="sidebar-container d-none d-md-flex flex-column p-0 m-0">
    ...
    <nav>
        ...
        <a href="#" class="sidebar-link" onclick="showSection(event, 'hours')">
...
<script>
    function showSection(event, sectionID) {
        ...
        // Hide all sections
        document.querySelectorAll('#dashboard, #requirement, #weeklyreport, #hours, #requirements-folder, #profile').forEach(section => {
