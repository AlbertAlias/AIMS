                        ...
                        <form>
                            ...
                            <div class="mb-3 d-flex justify-content-between align-items-center">
                                <label class="form-label" for="gender">
                                    <i class="fa-solid fa-venus-mars fa-lg" style="color: #198754;"></i>
                        ...
                        <form>
                            <div class="mt-2 mb-3 d-flex justify-content-between align-items-center">
                                <label class="form-label" for="company">
                                    <i class="fa-solid fa-handshake fa-lg" style="color: #198754;"></i>
                            ...
                            <div class="mb-3 d-flex justify-content-between align-items-center">
                                <label class="form-label" for="company-supervisor">
                                    <i class="fa-solid fa-user-tie fa-lg" style="color: #198754;"></i>
