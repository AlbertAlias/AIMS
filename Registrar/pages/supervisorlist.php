<div class="container-fluid p-0 m-0" id="supervisorlist" style="display: none;">
    <div class="card" style="box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                <div class="d-flex align-items-center gap-2">
                    <div class="d-flex align-items-center">
                        <select id="supervisor-lists-pageLengthSelect" class="form-select form-select-sm custom-select" aria-label="Page length selector">
        ...
        <div class="card-footer bg-light text-dark">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                <span class="mb-2" id="supervisor-lists-tableInfo">Showing 0 to 0 of 0 entries</span>
                <nav aria-label="Page navigation">
                    <ul id="supervisor-lists-pagination" class="pagination mb-0">
