...
<script>
    function showSection(event, sectionID) {
        ...
        // Hide all sections
        document.querySelectorAll('#evaluation, #profile').forEach(section => {
    ...
    window.onload = function () {
        ...
        showSection(null, 'evaluation');

        // Mark the dashboard link as active on load
        document.querySelector('a[href="#"][onclick*="evaluation"]').classList.add('active');
    };
</script>