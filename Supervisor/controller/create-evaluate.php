...
//         $stmt = $conn->prepare("
//             INSERT INTO supervisor_evaluations (student_id, total_grade, comments, evaluator_id, evaluation_date)
//             VALUES (?, ?, ?, ?, NOW())
//         ");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt = $conn->prepare(
            "INSERT INTO supervisor_evaluations (student_id, total_grade, comments, evaluation_date)
            VALUES (?, ?, ?, NOW())"
        );
